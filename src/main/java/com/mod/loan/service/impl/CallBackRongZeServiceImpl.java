...
public class CallBackRongZeServiceImpl implements CallBackRongZeService {
    ...
    @Override
    public void pushRiskResult(OrderUser orderUser, String riskCode, String riskDesc) {
        try {
            //只推审核通过跟审核拒绝
    ...
    private void postRiskResult(OrderUser orderUser, String riskCode, String riskDesc) throws Exception {
