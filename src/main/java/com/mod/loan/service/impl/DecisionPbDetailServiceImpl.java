...
//            redisMapper.set(serials_no, user.getId()+"&" + times);
            ...
            riskData.put("apply_channel", "rong360");
            ...
            if(userInfo != null ) {
                ...
                riskData.put("company_phone", "");
                riskData.put("company_name", userInfo.getWorkCompany());
            }
            riskData.put("contact_list", contactList(user));
            ...
            riskData.put("apply_time", approvalTerm);
