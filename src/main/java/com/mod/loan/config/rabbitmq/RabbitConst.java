...
public class RabbitConst {
    ...
    public final static String qjld_queue_risk_order_result_wait = "qjld_queue_risk_order_result_wait"; // 全景雷达风控订单结果等待10s
    ...
    public final static String pb_queue_risk_order_result_wait = "pb_queue_risk_order_result_wait"; // 盘宝风控风控订单结果等待10s
