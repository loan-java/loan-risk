...
public class UserBank {
    ...
    @Column(name = "card_code_helipay")
    private String cardCodeHelipay;
    /**
     * @return id
     */
    public Long getId() {
	...
	public String getCardCodeHelipay() {
		return cardCodeHelipay;
	}

	public void setCardCodeHelipay(String cardCodeHelipay) {
		this.cardCodeHelipay = cardCodeHelipay;
	}
